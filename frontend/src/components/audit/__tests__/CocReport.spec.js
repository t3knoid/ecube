...
describe('CocReport', () => {
  it('renders a structured report with separate manifest summary and processor notes sections', () => {
    const wrapper = mountView()

    expect(wrapper.text()).toContain('PRJ-777 - EV-777')
    ...
    expect(wrapper.text()).toContain('Manifest Summary')
    expect(wrapper.text()).toContain('Project Binding')
    expect(wrapper.text()).toContain('PRJ-777')
    expect(wrapper.text()).toContain('Generated By')
    ...
    expect(wrapper.text()).not.toContain('Latest Manifest Path')
    expect(wrapper.text()).not.toContain('Manifest Count')
