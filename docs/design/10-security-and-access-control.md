...
- All error responses use the standardized `ErrorResponse` JSON schema (see [06-rest-api-specification.md](06-rest-api-specification.md#standardized-error-response-format)); `401`, `403`, `404`, `409`, `422`, `500`, `503`, and `504` responses are declared in the OpenAPI specification for every endpoint via reusable response dicts in `app/schemas/errors.py`.
