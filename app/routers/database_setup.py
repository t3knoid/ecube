...
from app.schemas.errors import R_400, R_401, R_403, R_409, R_422, R_500, R_503
...
@router.post(
    ...
    responses={**R_400, **R_401, **R_403, **R_422, **R_503},
)
...
@router.post(
    ...
    responses={**R_400, **R_401, **R_403, **R_409, **R_422, **R_500, **R_503},
)
