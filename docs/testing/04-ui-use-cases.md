...
| UC-4.2 | Filter/search drives by state (DISABLED, UNMOUNTED, AVAILABLE, IN_USE) and optionally include DISCONNECTED rows | Any authenticated user | any |
