...
def list_drives(
    ...
    state: Optional[List[str]] = Query(
        default=None,
        description="Filter drives by state (repeatable). Valid values: DISCONNECTED, DISABLED, AVAILABLE, IN_USE.",
    ),
    ...
    By default only drives in non-``DISCONNECTED`` states (``DISABLED``,
