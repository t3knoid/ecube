...
class TestOpenAPISchema:
    ...
    def test_protected_endpoints_have_security_requirement(self):
        ...
        openapi_schema = app.openapi()
        unauthenticated_paths = {"/health", "/health/live", "/health/ready", "/metrics", "/auth/token", "/auth/public-config", "/setup/status", "/setup/initialize", "/introspection/version", "/setup/database/system-info"}
        violations = []
    ...
    def test_protected_endpoints_declare_401_and_403(self):
        ...
        unauthenticated_paths = {
            "/health", "/health/live", "/health/ready", "/metrics", "/auth/token", "/auth/public-config", "/setup/status", "/setup/initialize",
